...
(function ($) {
    $.formValidator = {
        ...
        appendValid:function (id, setting) {
            ...
            if (!$.formValidator.sustainType(elem, validateType)) {
                return -1
            }
            //重新初始化
        ...
        oneIsValid:function (id) {
            ...
            for (var i = 0; i < settingslen; i++) {
                ...
                if (!e.settings[i].isValid) {
                    ...
                    e.isValid = true;
                    e.setting = e.settings[0];
                    if (e.settings[i].validateType == "ajaxValidator") {
                        break
                    }
                    ;
                }
                ...
                if (this.settings[0].bind) {
                    ...
                    if (name_list.indexOf("^" + name + "^") == -1) {
                        ...
                        if (returnObj) {
                            ...
                            if (initConfig.oneByOneVerify && !returnObj.isValid) {
                                return false
                            }
                        }
                    }
    ...
    $.fn.formValidator = function (cs) {
        ...
        return this.each(function (e) {
            ...
            if (initConfig.mode == "AutoTip" || initConfig.mode == "FixTip") {
                ...
                tipDiv.css("background", "transparent");
            ...
            if (fixTip.length == 1 && onMouseOutFixTextHtml != "" && onMouseOnFixTextHtml != "" && showFixText != "") {
                ...
                fixTip.html(onMouseOutFixTextHtml.replace(/\$data\$/g, setting.onShowFixText));
                // .css("padding", "0px 0px 0px 0px").css("margin", "0px 0px 0px 0px")
            }
            //获取输入框内的提示内容
...
var formValidator_setting = {
    validatorGroup:"1",
    onShowText:"",
    onShowTextColor:{mouseOnColor:"#000000", mouseOutColor:"#000"},
    onShowFixText:"",
    onShow:"请输入内容",
    onFocus:"请输入内容",
    onCorrect:"输入正确",
