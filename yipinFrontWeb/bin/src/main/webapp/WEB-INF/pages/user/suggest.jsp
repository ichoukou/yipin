		...
		<div class="uc cf">
			...
			<div class="uc_r">
				...
				<div class="my_find">
					...
					<div class="send cf">
						<form action="" id="mySuggestForm">
						<input type="hidden" id="types" name="suggest.type" value="${suggestPage.params.type}"/>
							<h3 id="sub">我要吐槽</h3>
							<div class="fn_left relative">
								<textarea name="suggest.content" id="myFindText" class="input-default" data-default="请在这里写下您想告诉我们的任何内容。我们将尽快完善这些问题，请随时回来视察我们的工作，并查看您的积分，会有惊喜哦。"></textarea>
								<span id="myFindTextTip"></span>
							</div>
							<div class="fn_right">
								<a href="javascript:" class="sendBtn" id="sendBtn">下达指令</a>
							</div>
						</form>
					</div>
					<!-- 分页 -->
