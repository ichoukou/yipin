...
<body>
	...
	<div class="w_norm">
		...
		<div class="uc cf">
			...
			<div class="uc_r">
				<div class="ucr_hd">
					<a href="${_ctxPath}/order/order-myOrderCancelManage.htm" class="on"><span>退款申请</span></a>
					<span>|</span>
					<a href="${_ctxPath}/order/order-myOrderCancelRecord.htm">退款记录</a>
					<span>|</span>
					<span class="f12">您可以在此申请退款以及查询退款订单进度</span>
				</div>
				...
				<div class="my_order">
					...
					<!-- 分页导航 start-->
					<yp:yipinFrontPage urlEnd=".htm" urlStart="order-myOrderCancelManage-${orderPage.total}-" page="${orderPage}"></yp:yipinFrontPage>
					<!-- 分页导航 end-->
				</div>
				</c:if>
				<c:if test="${empty orderPage.result}">
					<div class="noRecord">没有可以退款的商品！</div>
				</c:if>
			</div>
			<!-- 用户中心右侧 end-->
		</div>
