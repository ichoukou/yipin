	...
	<div class="lf_nav">
		...
		<div class="bd">
		    <ul>
				...
				<li class="uc_i3" id="myOrderCancelManage"><a href="${_ctxPath}/order/order-myOrderCancelManage.htm">退款管理</a></li>
...
window.onload=function(){
	...
	}else if(url.indexOf("Cancel") > 0 ||url.indexOf("cancel") > 0 ){
		$("#myOrderCancelManage").addClass("on").siblings().removeClass("on");
