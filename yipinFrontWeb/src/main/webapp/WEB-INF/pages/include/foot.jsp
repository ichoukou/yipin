			...
			<div class="help">
				...
				<dl>
					...
					<c:forEach items="${helpCategory.helpCategorys}" var="help" varStatus="index">
                           <dd><a target="_blank" href="${_ctxPath}/help/help-${help.help.helpId}.htm" id="${index.index}_help"  rel="nofollow"><span >${help.name}</span></a></dd>
                       </c:forEach>
...
<script type="text/javascript" src="${_jsPath }/plugin/Xslider/slides.min.jquery.js"></script>
