			...
			<div class="login_left fn_left">
				...
				<div class="login_bd">
					<form action="" id="register_form">
						<p class="f14">用户名：</p>
						<div class="relative"><label for="mail" class="labelPsw" id="usernameStr">请输入6-25字符的用户名，建议使用邮箱或者手机号</label><input type="text" class="input-text input-default" name="username" autocomplete="off" id="mail"/><span id="mailTip"></span></div>
						<p class="f14">密码：</p>
						<div class="relative"><label for="password" class="labelPsw" id="passwordStr">请输入6-15位数字、字母或符号组合，建议混合使用</label><input type="password" name="password" class="input-text" id="password" autocomplete="off"/><span id="passwordTip"></span></div>
						<p class="f14">确认密码：</p>
