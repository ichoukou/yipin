...
<jsp:include page="../include/header.jsp"></jsp:include> 
	<div class="body m-w980p">
		...
		<div class="m-mt10p addsanpUp">
			<form id="addDetailzoneFrm" action="${_ctxPath}/admin/zone/zone-saveZone.htm" method="post">
				<div>
				...
				<c:if test="${zone.zoneSaleList!=null}">
					<c:forEach items="${zone.zoneSaleList}" var="zoneSale">
						<input type="hidden" value="${zoneSale.productId}"  class="pid"/>
	...
	<script type="text/javascript" src="${_jsPath }/pages/addsnapUp2.js"></script>
</body>
</html>