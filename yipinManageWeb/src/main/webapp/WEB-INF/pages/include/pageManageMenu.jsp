...
<%@ taglib prefix="aut" uri="http://www.springsecurity.org/jsp"%>
 <div class="body-nav m-mt10p">
        <ul class="m-clear">
			...
			<aut:authorize url="/admin/notice/notice-searchNotice">
			 	<li><a href="${_ctxPath}/admin/notice/notice-searchNotice.htm" id="notice">最新动态</a></li>
			 </aut:authorize>
			 <aut:authorize url="/admin/adv/show">
			 	<li><a href="${_ctxPath}/admin/adv/show.htm" id="adv">广告位</a></li>
			 </aut:authorize>
        </ul>
   </div>
 ...
 $(function(){
 	...
 	if(url.indexOf("suggest-searchSuggests") > 0){
 		...
 		return false;
 	}else if(url.indexOf('show')>0||url.indexOf('adv_goToAdd')>0){
